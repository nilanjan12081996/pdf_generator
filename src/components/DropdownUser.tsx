...
import { logo, userFace } from '../assets/images/images';
    ...
    <div className="relative">
      ...
      >
        <span className="hidden text-right lg:block">
          <span className="block text-sm font-medium text-[#DFDFDF] font-SatoshiMedium">
            User Name
          </span>
        </span>

        <span className="h-[40px] w-[40px] rounded-full">
